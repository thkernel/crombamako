	...
	<div class="container main-container">
		<div class="br-pageheader mg-t-20 mg-b-20">
	      <nav class="breadcrumb pd-0 mg-0 tx-12">
	        ...
	        <span class="breadcrumb-item active"><h5>Situation des médecins & agréements</h5></span>
	      </nav>
	    </div><!-- br-pageheader -->

		<div class="row">
		    <div class="col-md-12">
		    	@include('doctor_situation/partials/_search_bar_approval')
			</div>
		</div>
	</div>
            		...
            		<div class="row">
                		<div class="col-md-12">
                			<div class="left-content">
                				<form action="{{ route('download_doctor_situation_approval_pdf_path')}}" method="GET">
                            @csrf 

                            <input type="hidden" name="pdf_speciality_id" value="{{$speciality_id ?? ''}}">

                            <input type="hidden" name="pdf_approval" value="{{$approval ?? ''}}">

                           
                            <a href="route('download_doctor_situation_approval_pdf_path')"

...
<div class="br-pagebody mg-b-30">
  <div class="br-section-wrapper">
    <div class="headers mg-b-5">
       <h2>Modification - Montant cotisation</h2>
       <hr />
...
<form action="{{ route('price_configurations.update',$price_configuration->id) }}" method="POST">

    @csrf
    @method('PUT')

  @include("price_configurations/_form")

...
<a href="#" data-toggle="modal" data-target="#prestation-modal">
    <i class="fa fa-trash" aria-hidden="true" title="Supprimer" ></i>
    Supprimer
</a>

<div id="prestation-modal" class="c-modal modal fade" data-backdrop="static">
<!-- Modal -->
      ...
      <div class="modal-header pd-y-20 pd-x-25">
        ...
        <div class="modal-footer">
            ...
            <form action="{{ route('prestations.destroy', $prestation->id)}}" method="post">
                            @csrf @method('DELETE')
                            <a href="route('prestations.destroy', $prestation->id)"

  ...
  <div class="br-section-wrapper">
    <div class="headers mg-b-20">
        ...
        <div class="text-right">
            ...
            <a class="btn btn-primary tx-mont tx-medium tx-11 tx-uppercase pd-y-12 pd-x-25 tx-spacing-1" href="{{ route('pages.create') }}"><i class="fa fa-plus" aria-hidden="true"></i>Ajouter</a>
